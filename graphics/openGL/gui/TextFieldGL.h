...
#else
	GLfloat vert1[] = {
		mAnchorX - borderOffset, mAnchorY - borderOffset,
		mAnchorX - borderOffset, mAnchorY + mHeight + borderOffset,
		mAnchorX + mWidth + borderOffset, mAnchorY + mHeight + borderOffset,
		mAnchorX + mWidth + borderOffset, mAnchorY - borderOffset
	};
...
#else
	GLfloat vert2[] = {
		mAnchorX - offset, mAnchorY - offset,
		mAnchorX - offset, mAnchorY + mHeight + offset,
		mAnchorX + mWidth + offset, mAnchorY + mHeight + offset,
		mAnchorX + mWidth + offset, mAnchorY - offset
	};
...
#else
        GLfloat vert3[] = {
		cursorViewX - cursorOffset, mAnchorY,
		cursorViewX - cursorOffset, mAnchorY + mHeight,
		cursorViewX + cursorOffset, mAnchorY + mHeight,
		cursorViewX + cursorOffset, mAnchorY
	};
